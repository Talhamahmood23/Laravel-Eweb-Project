...
<div class="content-wrapper">
    ...
    $res = $fn->get_data('admin', $columns = ['password', 'email'], 'username = "' . $username . '"');
    ...
    <section class="content-header">
        ...
        <div class="msg">
            <?= isset($error['update_user']) ? $error['update_user'] : ''; ?>
        </div>
        <hr />
    </section>
                    ...
                    <form id='change_password_form' method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <span class="label label-primary">If you change username or password you will need to
                                    login again.</span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Username : </label>
                                <input type="text" class="form-control" name="username" id="disabledInput"
                                    value="<?= $username; ?>" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="msg">
                                    <?= isset($error['old_password']) ? $error['old_password'] : ''; ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="msg">
                                    <?= isset($error['new_password']) ? $error['new_password'] : ''; ?>
                                </div>
