...
define('DOMAIN_URL', 'http://ecartdev.wrteam.co.in/'); /*chnage to your domain here*/
...
class Database
{
    ...
    private $db_user = "wrteamja_ecartdev";  // Change as required
    private $db_pass = "VN]6zVXUo3SK";  // Change as required
    private $db_name = "wrteamja_ecartdev";    // Change as required
