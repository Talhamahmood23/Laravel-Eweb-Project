            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php $other_images = isset($data['other_images']) ? json_decode($data['other_images']) : '';
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <a href="delete-product.php?id=<?php echo $data['id']; ?>"><button class="btn btn-danger">Delete</button></a>
                    </div>
                </div><!-- /.box -->
            </div>
        </div>
