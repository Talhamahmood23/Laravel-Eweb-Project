            ...
            <?php if ($permissions['customers']['read'] == 1) { ?>
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-hover" id="user_table" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=users" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-show-clear="true" data-query-params="queryParams_1" data-sort-name="id" data-sort-order="desc">
                            <thead>
                                <tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-hover" id="user_addresses_table" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=user_address" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="false" data-trim-on-search="false" data-filter-show-clear="true" data-query-params="queryParams_2" data-sort-name="id" data-sort-order="desc">
                        <thead>
                            <tr>
                                <th data-field="id" data-sortable="true">ID</th>
    ...
    window.actionEvents = {
        'click .set-product-deactive': function(e, value, rows, index) {
            ...
            $.ajax({
                ...
                type: "get",
                data: 'id=' + p_id + '&status=1&type=deactive',
        ...
        'click .set-product-active': function(e, value, rows, index) {
            ...
            $.ajax({
                url: 'public/db-operation.php',
                type: "get",
                data: 'id=' + p_id + '&status=1&type=active',
                success: function(result) {
                    if (result == 1)
                        $('#user_table').bootstrapTable('refresh');
                    else
