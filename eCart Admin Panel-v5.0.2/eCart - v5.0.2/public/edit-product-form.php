...
if (isset($_POST['btnEdit'])) {
    ...
    if ($permissions['products']['update'] == 1) {
        ...
        if (!empty($name) && !empty($category_id) &&  !empty($serve_for) && !empty($description) && empty($error['cancelable']) && empty($error)) {
            ...
            for ($i = 0; $i < $count; $i++) {
                $vari_image = $fn->get_data('product_variant', $columns = ['id', 'images'], 'id=' . $_POST['product_variant_id'][$i]);
                ...
                if ($_POST['type'] == "packet") {
                    ...
                    $data = array(
                        ...
                        'hsn_code' => $db->escapeString($fn->xss_clean($_POST['packate_hsn_code'][$i])),
                    );

                    $db->update('product_variant',  'id=' . $fn->xss_clean($_POST['product_variant_id'][$i]), $data);
                    $res = $db->getResult();
                    ...
                    $data = array(
                        ...
                        'hsn_code' => $db->escapeString($fn->xss_clean($_POST['loose_hsn_code'][$i])),
                    );
                    $db->update('product_variant',  'id=' . $fn->xss_clean($_POST['product_variant_id'][$i]), $data);
                    $res = $db->getResult();
                }
            ...
            if (
                ...
                for ($i = 0; $i < count($_POST['insert_packate_measurement']); $i++) {
                    ...
                    if ((isset($_FILES['insert_packet_variant_images'])) && (!empty($_FILES['insert_packet_variant_images']['name'][$i][0])) && ($_FILES['insert_packet_variant_images']['size'][$i][0] > 0)) {
                        ...
                        $variant_images = isset($file_data) ? json_encode($file_data) : "";
                    }
                    ...
                    $product_hsn_code = $db->escapeString($fn->xss_clean($_POST['insert_packate_product_hsn_code'][$i]));

                    $sql = "INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,stock,stock_unit_id,serve_for,images,sku,hsn_code) VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$stock','$stock_unit_id','$serve_for','$variant_images','$product_sku','$product_hsn_code')";
                    $db->sql($sql);
                }
            }
            ...
            if (
                ...
                for ($i = 0; $i < count($_POST['insert_loose_measurement_unit_id']); $i++) {
                    ...
                    if ($_FILES["insert_loose_variant_images"]["error"][$i][0] == 0) {
                        for ($j = 0; $j < count((array)$_FILES["insert_loose_variant_images"]["name"][$i]); $j++) {
                    ...
                    $product_hsn_code = $db->escapeString($fn->xss_clean($_POST['insert_loose_product_hsn_code'][$i]));
                ...
                <form id='edit_product_form' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row packate_div">
                            ...
                            <div class="col-md-2">
                                <div class="form-group packate_div">
                                    <label for="exampleInputEmail1">Measurement</label> <i
                                        ...
                                        class="form-control measurement" name="packate_measurement[]"
                                ...
                                <div class="form-group packate_div">
                                    ...
                                    <select name="packate_serve_for[]" class="form-control">
                                        <option value="Available"
                                            <?php (strtolower($row['serve_for']) == "availabel") ? "selected" : ''; ?>>
                                            Available</option>
                                        <option value="Sold Out"
                                            <?php (strtolower($row['serve_for']) == "sold out")  ? "selected" : ''; ?>>
                                            Sold Out</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <?php } else { ?>
                            <div class="col-md-1  packate_div" style="display: grid;">
                                <label>Remove</label>
                            ...
                            <div class="col-md-4  packate_div">
                                <div class="form-group packate_div">
                            ...
                            <div class="col-md-4  packate_div">
                                <div class="form-group packate_div">
                                    <label for="packate_hsn_code">HSN code:</label>
                                    <input type="text" class="form-control" name="packate_hsn_code[]"
                                        value='<?= $row['hsn_code']; ?>' />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group packate_div">
                                    <label for="exampleInputFile">Variant Images &nbsp;&nbsp;&nbsp;(Please choose square
                                        image of larger than 350px*350px & smaller than
                            ...
                            <div class="row packate_div">
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i> <input type="number" step="any" min="0"
                                            class="form-control measurement" name="packate_measurement[]" required />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="price">Price (<?= $settings['currency'] ?>):</label> <i
                                            class="text-danger asterik">*</i> <input type="number" step="any" min="0"
                                            class="form-control" name="packate_price[]" id="packate_price" required />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="discounted_price">Discount Price
                            ...
                            <div class="row loose_div">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i>
                                        <input type="number" step="any" min="0" class="form-control measurement"
                                ...
                                <?php if ($i == 0) { ?>
                                <div class='col-md-1  loose_div'>
                                    <label>Variation</label>
                                    <a id='add_loose_variation' title='Add variation of product'
                                        style='cursor: pointer;'><i class="fa fa-plus-square-o fa-2x"></i></a>
                                </div>
                                <?php } else { ?>
                                <div class="col-md-1  loose_div" style="display: grid;">
                                    <label>Remove</label>
                                    <a class="remove_variation text-danger" data-id="data_delete"
                                        title="Remove variation of product" style="cursor: pointer;"><i
                                            class="fa fa-times fa-2x"></i></a>
                                ...
                                <div class="col-md-4  loose_div">
                                    <div class="form-group loose_div">
                                        <label for="loose_hsn_code">HSN code:</label>
                                        <input type="text" class="form-control" name="loose_hsn_code[]"
                                            value='<?= $row['hsn_code']; ?>' />
                                    </div>
                                </div>

                                <div class="col-md-6  loose_div">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputFile">Variant Other Images <i
                                                class="text-danger asterik">*</i> &nbsp;&nbsp;&nbsp;*Please choose
                                            square image of larger than 350px*350px & smaller than
                        ...
                        <div class="form-group">
                            <label for="stock_unit">Unit
                                :</label><?= isset($error['stock_unit']) ? $error['stock_unit'] : ''; ?>
                    ...
                    <div class="form-group">
                        <div class="form-group" id="status_div"
                            <?php ($res[0]['type'] == "packet") ? "style='display:none'" : ''; ?>>
                            <label for="exampleInputEmail1">Status
                                :</label><?= isset($error['serve_for']) ? $error['serve_for'] : ''; ?>
                            <select name="serve_for" class="form-control">
                                <option value="Available"
                                    <?php (strtolower($res[0]['serve_for']) == "available") ? "selected" : ''; ?>>
                                    Available</option>
                                <option value="Sold Out"
                                    <?php (strtolower($res[0]['serve_for']) == "sold out") ? "selected" : ''; ?>>Sold
                                    Out</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <?= isset($error['category_id']) ? $error['category_id'] : ''; ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="indicator" id="indicator" class="form-control">
                                    ...
                                    <option value="2" <?= ($res[0]['indicator'] == 2) ? 'selected' : ''; ?>>Non Veg
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            ?>
                                <div class="col-md-3" id="till-status" style="<?= $style; ?>">
                                    <div class="form-group">
                                        ...
                                        <?= isset($error['cancelable']) ? $error['cancelable'] : ''; ?><br>
                                        <select id="till_status" name="till_status" class="form-control">
                                            <option value="">Select</option>
                                            <option value="received"
                                                <?= $res[0]['till_status'] == 'received' ? 'selected' : '' ?>>Received
                                            </option>
                                            <option value="processed"
                                                <?= $res[0]['till_status'] == 'processed' ? 'selected' : '' ?>>Processed
                                            </option>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Image <i class="text-danger asterik">*</i>
                                    ...
                                    than 550px*550px.</label><?= isset($error['image']) ? $error['image'] : ''; ?>
                                <input type="file" name="image" id="image"
                                    title="Please choose square image of larger than 350px*350px & smaller than 550px*550px." /><br />
                                <img src="<?= $data['image']; ?>" width="210" height="160" />
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Other Images *Please choose square image of larger than
                                    350px*350px & smaller than
                                    550px*550px.</label><?= isset($error['other_images']) ? $error['other_images'] : ''; ?>
                            ...
                            <div class="form-group">
                                <label for="size_chart">Size Chart : &nbsp;&nbsp;&nbsp;*Please choose square image of
                                    larger than 350px*350px & smaller than
                                    550px*550px.</label><?= isset($error['size_chart']) ? $error['size_chart'] : ''; ?>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Description :</label> <i
                                    class="text-danger asterik">*</i><i class="address_note"></i>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">shipping_delivery : </label><i
                                    class="address_note"></i><?= isset($error['shipping_delivery']) ? $error['shipping_delivery'] : ''; ?>
                                <textarea name="shipping_delivery" id="shipping_delivery"
                                    class="form-control addr_editor"><?= $data['shipping_delivery']; ?></textarea>
                            </div>
                            <div class="form-group">
...
$('#add_loose_variation').on('click', function() {
    html = '<div class="row  loose_div"><hr><div class="col-md-4"><div class="form-group loose_div">' +
        ...
        '</div></div>' +
        '<div class="col-md-2  loose_div"><div class="form-group loose_div">' +
        '<label for="unit">Unit:</label>' +
        ...
        '</select></div></div>' +
        '<div class="col-md-3  loose_div"><div class="form-group loose_div">' +
        ...
        '<div class="col-md-4  loose_div"><div class="form-group loose_div">' +
        '<label for="insert_loose_product_sku">SKU:</label>' +
        '<input type="text" class="form-control" name="insert_loose_product_sku[]" />' +
        '</div></div>' +

        '<div class="col-md-4  loose_div"><div class="form-group loose_div">' +
        '<label for="insert_loose_hsn_code">HSN code:</label>' +
        '<input type="text" class="form-control" name="insert_loose_hsn_code[]" />' +
        '</div></div>' +

        '<div class="col-md-6  loose_div"><div class="form-group loose_div">' +
...
$('#add_packate_variation').on('click', function() {
    html = '<div class="row packate_div"><hr><div class="col-md-2"><div class="form-group packate_div">' +
        ...
        '</div></div>' +
        '<div class="col-md-1 packate_div"><div class="form-group packate_div">' +
        '<label for="unit">Unit:</label>' +
        ...
        '</select></div></div>' +
        '<div class="col-md-2 packate_div"><div class="form-group packate_div">' +
        ...
        '</select></div></div>' +
        '<div class="col-md-2 packate_div"><div class="form-group packate_div"><label for="insert_packate_serve_for">Status:</label>' +
        ...
        '<div class="col-md-4 packate_div"><div class="form-group packate_div">' +
        '<label for="insert_packate_product_sku">SKU:</label>' +
        '<input type="text" class="form-control" name="insert_packate_product_sku[]" />' +
        '</div></div>' +

        '<div class="col-md-4 packate_div"><div class="form-group packate_div">' +
        '<label for="insert_packate_hsn_code">HSN code:</label>' +
        '<input type="text" class="form-control" name="insert_packate_hsn_code[]" />' +
        '</div></div>' +

        '<div class="col-md-6 packate_div"><div class="form-group packate_div">' +
        '<label for="exampleInputFile">Variant Other Images <i class="text-danger asterik">*</i> &nbsp;&nbsp;&nbsp;*Please choose square image of larger than 350px*350px & smaller than 550px*550px.</label><?= isset($error['variant_images']) ? $error['variant_images'] : ''; ?>' +
