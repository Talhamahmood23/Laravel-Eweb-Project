...
foreach ($res_outer as $row) {
    ...
    $data = array($row['product_id'], $row['pname'], $row['quantity'], $row['measurement'], $row['mesurement_unit_name'], $row['discounted_price'] * $row['quantity'], $row['discount'], $row['sub_total'], $row['order_item_status'], $row['tax_id'], $row['hsn_code'], $final_price);
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-2 invoice-col">
                ...
                <address>
                    <b>Date: </b>
                    <?= date('d-m-Y', strtotime($res_outer[0]['order_date_added'])); ?>
                </address>
                <address>
                    <b>Order ID: </b>#
                    <?= $res_outer[0]['id']; ?>
                ...
                <address>
                    <b>Date: </b>
                    <?= date('d-m-Y h:i A', strtotime($res_outer[0]['order_date_added'])); ?>
                </address>
            </div>
        </div>
        <div class="row1">
                            ...
                            if ($item[8] != 'cancelled' && $item[8] != 'returned') {
                                ...
                                <tr>
                                    ...
                                    <?php if ($item[9] != 0) {
                                        ...
                                        ?>
                                        <td>
                                            <?php echo $tax_amount2 . " (" . $res_tax[0]['percentage'] . "%) " . $res_tax[0]['title'];
                ...
                <div class="table-responsive">
                    <table class="table borderless heading">
                        ...
                        <tr>
                            ...
                            <td>
                                <?= '- ' . $discount_in_rupees . ' (' . $res_outer[0]['discount'] . '%)'; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Promo (
                                <?= $res_outer[0]['promo_code']; ?>) Discount (
                                <?= $currency; ?>)
                            </th>
                            <td>
                                <?= '- ' . $res_outer[0]['promo_discount']; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Wallet Used (
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <form><button type='button' value='Print this page' onclick='printpage();' class="btn btn-default"><i
