        ...
        if (!empty($name) && !empty($category_id) && !empty($serve_for) && empty($error['cancelable']) && !empty($description)) {
            ...
            if ($product_result == 1) {
                ...
                if ($_POST['type'] == 'packet') {
                    ...
                    $packate_measurement = $_POST['packate_measurement'];
                    ...
                    for ($i = 0; $i < count($_POST['packate_measurement_unit_id']); $i++) {
                        ...
                        $product_hsn_code = $db->escapeString($fn->xss_clean($_POST['packate_hsn_code'][$i]));


                        $sql = "INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,serve_for,stock,stock_unit_id,images,sku,hsn_code)
                         VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$serve_for','$stock','$stock_unit_id','$variant_other_images','$product_sku','$product_hsn_code')";
                        $db->sql($sql);
                    ...
                    for ($i = 0; $i < count($_POST['loose_measurement_unit_id']); $i++) {
                        ...
                        $product_hsn_code = $db->escapeString($fn->xss_clean($_POST['loose_hsn_code'][$i]));


                        $sql = "INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,serve_for,stock,stock_unit_id,images,sku,hsn_code) VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$serve_for','$stock','$stock_unit_id','$variant_other_images','$product_sku',' $product_hsn_code')";
                        $db->sql($sql);
                        $product_variant = $db->getResult();
                    }
                    if (!empty($product_variant)) {
                    ...
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        ...
                                        <input type="number" step="any" min="0" class="form-control measurement"
                                            name="packate_measurement[]" required id="p_measurement" />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                        ...
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="packate_stock[]" required="" id="p_stock" />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i>
                                        <input type="number" step="any" min="0" class="form-control measurement"
                                            id="l_measurement" name="loose_measurement[]">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group loose_div">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="loose_stock_name" id="l_stock"><br>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="image">Main Image : <i
                                ...
                                600px</label><?php echo isset($error['image']) ? $error['image'] : ''; ?>
                        ...
                        <div class="form-group">
                            <label for="size_chart">Size Chart : &nbsp;&nbsp;&nbsp;*Please choose square image of larger
                                than 350px*350px & smaller than
                                550px*550px.</label><?php echo isset($error['size_chart']) ? $error['size_chart'] : ''; ?>
                            <input type="file" name="size_chart" id="size_chart">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Description :</label> <i class="text-danger asterik">*</i><i
                                class="address_note"></i>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="shipping_delivery" id="shipping_delivery"
                                class="form-control addr_editor"></textarea>
                        </div>
                    </div>
...
$('#add_packate_variation').on('click', function() {
    html =
        '<div class="row"><hr><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
...
$('#add_loose_variation').on('click', function() {
    html =
        '<div class="row"><hr><div class="col-md-4"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
