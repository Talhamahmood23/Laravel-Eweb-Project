<?php
if (isset($_GET) && isset($_GET['purchase_code_web']) && !empty($_GET['purchase_code_web']) || isset($_GET['purchase_code_cust']) && !empty($_GET['purchase_code_cust']) || isset($_GET['purchase_code_admin']) && !empty($_GET['purchase_code_admin'])) {
    $code = (isset($_GET['purchase_code_web']) || ($_GET['purchase_code_cust']) || ($_GET['purchase_code_admin'])) ? $_GET['purchase_code_web']|| $_GET['purchase_code_cust'] || $_GET['purchase_code_admin'] : "";
    $error = false;
