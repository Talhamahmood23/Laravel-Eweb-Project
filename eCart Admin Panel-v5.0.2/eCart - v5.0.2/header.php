                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="sections-order.php"><i class="fa fa-reorder"></i> Featured Sections Order</a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="flash-sales-products.php"><i class="fa fa-exchange"></i> Flash Sales Products
                                </a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="manager-app-privacy-policy.php"><i class="fa fa-lock"></i> Manager App Privacy
                                    Policy </a></li>
