...
(function(factory) {
    ...
    Rating.prototype = {
        ...
        _init: function(options) {
            var self = this,
                $el = self.$element.attr('tabindex', -1).addClass('rating-input'),
                v,
                m = self.minThreshold;
            ...
            self.events = {
                ...
                keydown: function(e) {
                    ...
                    var $el = self.$element,
                        ...
                        val = v ? parseFloat(v) : 0,
                        key = parseInt(e.which || e.keyCode || 0, 10);
        ...
        _listen: function() {
            var self = this,
                ...
                events = self.events,
                ns = $h.NAMESPACE,
                mouseEvents = 'mousenter' + ns + ' mouseleave' + ns,
                $stars = self.$rating.find('.star');
            ...
            $stars.off(mouseEvents).on(mouseEvents, function(e) {
                var $star = $(this),
                    index = $star.index(),
                    status = $star.parent().attr('class').slice(0, -1);
        ...
        _initStarTitles: function(val) {
            ...
            var starTitles = self.starTitles,
                setTitles;
