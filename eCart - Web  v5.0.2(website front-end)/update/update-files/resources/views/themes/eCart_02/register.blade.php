            ...
            <form method='POST' id='registerForm'>
               ...
               <div class="form-group mt-1">
                  ...
                  <div class="ui search focus">
                     ...
                     <div class="ui left icon input card-detail-desc">
                        <p><span class="form-text  text-muted">{{__('msg.we_will_never_share_you_email_with_anyone_else')}}.</small></p>
                     </div>
                  </div>
               </div>
               ...
               <div class="form-row mt-1">
                  <div class="form-group col-lg-6 mt-1 col-md-12 col-12 mb-4">
                  ...
                  <div class="form-group col-lg-6 col-md-12 col-12 mb-4 ">
               ...
               <div class="form-group mt-1">
                  <div class="ui search focus">
                     <div class="ui left icon input ">
                        ...
                        <div class="custom-control-label">   {{__('msg.I am agree with')}}
                            <a href="{{ route('page', 'tnc') }}" target="_blank">{{__('msg.terms and contitions')}}</a>
                        </div>
                     </div>
                  </div>
                  <br/>
